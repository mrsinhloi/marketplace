package com.ehubstar.marketplace.db;
 ...
 */
public class TinyDB {
    public static final String API_URL_ACV = "API_URL_ACV";
    public static final String API_URL_NAMPHUONG = "API_URL_NAMPHUONG";

    public static final String IS_DEVICE_REGISTERED = "IS_DEVICE_REGISTERED";
    public static final String IS_PERSONAL_DEVICE = "IS_PERSONAL_DEVICE";
...
//        preferences = PreferenceManager.getDefaultSharedPreferences(appContext);
    ...
    private boolean saveBitmap(String fullPath, Bitmap bitmap) {
        ...
        try {
            ...
            bitmapCompressed = bitmap.compress(Bitmap.CompressFormat.JPEG, 80, out);
        } catch (Exception e) {
            e.printStackTrace();
