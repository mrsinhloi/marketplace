...
public class DateFormat {
	...
	public static final String DATE_FORMAT_EN_LONG="yyyy-MM-dd HH:mm";
	public static final String DATE_FORMAT_TITLE="ddMMM";


	public static final String DATE_FORMAT_VN = "dd/MM/yyyy";
	public static final String DATE_SALARY = "MM/yyyy";
